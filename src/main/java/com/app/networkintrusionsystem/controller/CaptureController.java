...
public class CaptureController {
    ...
    private void savePacketToJson(Map<String, Object> packetData) {
        ...
        File file = new File("src/main/resources/com/app/networkintrusionsystem/data/packet.json");
    ...
    private void goBack() {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/com/app/networkintrusionsystem/fxmlFiles/VisualizationPage.fxml"));
